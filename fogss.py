...
if __name__ == "__main__":
    ...
    print(f"Computing scalar and saving to {scalar_file}")
    with ProgressBar():
        scalar_sums = scalar_ds
        encoding = {var: comp for var in scalar_sums.data_vars}
        scalar_sums.to_netcdf(scalar_file, encoding=encoding)
    end = time.time()
