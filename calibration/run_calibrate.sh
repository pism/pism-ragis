...
resolution=2400
n=40
odir=${RAGIS_DIR}/calibration/2026_03_grimp_init
start="2007-01-01"
end="2010-01-01"
boot_file=$RAGIS_DIR/data/dem/boot_g${resolution}m_GreenlandObsISMIP7-v1.3.nc
indir=$odir

python calibrate.py --start $start --end $end --boot_file $boot_file  --force_to_thickness_file $boot_file  --exstep yearly --spatial_ts calibrate --data_dir $RAGIS_DIR/data --grid_file $RAGIS_DIR/data/grids/pism-bedmachine-greenland.nc -s chinook-40 -n $n -q t2small -w 2:00:00 --o_dir $odir -r $resolution -e $RAGIS_DIR/uq/ensemble_gris_calibrate.csv $RAGIS_DIR/calibration/2017_06_vc/state/gris_g${resolution}m_flux_v3a_no_bath_sia_e_1.25_sia_n_3_ssa_n_3.25_ppq_0.6_tefo_0.02_calving_vonmises_calving_0_100.nc

python adjust_tillwat.py --speed_file ../data/itslive/GRE_G0240_0000.nc ${odir}/state/g${resolution}m_id_BAYES-MEDIAN_${start}_${end}.nc ${odir}/state/g${resolution}m_id_BAYES-MEDIAN_${start}_${end}_tw.nc

odir=${RAGIS_DIR}/calibration/2026_03_grimp_tw
python calibrate.py --start $start --end $end --boot_file $boot_file  --force_to_thickness_file $boot_file  --exstep yearly --spatial_ts calibrate --data_dir $RAGIS_DIR/data --grid_file $RAGIS_DIR/data/grids/pism-bedmachine-greenland.nc -s chinook-40 -n $n -q t2small -w 2:00:00 --o_dir $odir -r $resolution -e $RAGIS_DIR/uq/ensemble_gris_calibrate.csv ${indir}/state/g${resolution}m_id_BAYES-MEDIAN_${start}_${end}_tw.nc
...
python calibrate.py --start $start --end $end --boot_file $boot_file  --force_to_thickness_file $boot_file  --exstep yearly --spatial_ts calibrate --data_dir $RAGIS_DIR/data --grid_file $RAGIS_DIR/data/grids/pism-bedmachine-greenland.nc -s chinook-40 -n $n -q t2standard -w 24:00:00 --o_dir $odir -r $resolution -e $RAGIS_DIR/uq/ensemble_gris_calibrate.csv $RAGIS_DIR/calibration/2017_06_vc/state/gris_g${resolution}m_flux_v3a_no_bath_sia_e_1.25_sia_n_3_ssa_n_3.25_ppq_0.6_tefo_0.02_calving_vonmises_calving_0_100.nc
