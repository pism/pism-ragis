...
grid=900
PISM_PREFIX=$HOME/local-intel/pism python hindcast.py --exstep monthly --spatial_ts ragis --data_dir /import/c1/ICESHEET/ICESHEET/pism-greenland/data_sets/ --dataset_version 2024-02_RAGIS -s chinook-rl8-24 -n 240 -q t2standard -w 24:00:00 --o_dir 2024_07_ragis_lhs_25 --start 1978-1-1 --end 2021-1-1 -g $grid -e ../uq/ensemble_gris_ragis_w_posterior_lhs_25.csv /import/c1/ICESHEET/ICESHEET/pism-greenland/calibration/2024_02_init_ragis_tw/state/gris_g900m_v2024-02_RAGIS_id_BAYES-MEDIAN_0_20.nc
